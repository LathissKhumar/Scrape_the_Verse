...
from LibreCrawl.engine import crawl_website, validate_url, format_error_result, CrawlJob
...
class TestHeadlessEngine(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.server = http.server.ThreadingHTTPServer(('127.0.0.1', TEST_PORT), MockSiteHandler)
