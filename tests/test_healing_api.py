...
from app.healing.schemas import PerformanceSnapshot, RepairEvaluation, RepairType
...
async def test_scrape_endpoint_returns_self_healed_metadata():
    ...
    with patch("app.main.workflow.ainvoke", new_callable=AsyncMock) as mock_invoke:
