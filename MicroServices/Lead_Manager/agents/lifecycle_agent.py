...
class LifecycleAgent:
    ...
    async def recommend_next_action(self, lead: Lead, context: Dict[str, Any]) -> Dict[str, Any]:
        stage = lead.stage
        if stage in (LeadStage.DISCOVERED, LeadStage.QUALIFIED):
            ...
            return {"next_step": "SEND_EMAIL", "delegated_service": "CommunicationService"}
        elif stage == LeadStage.MEETING_REQUESTED:
            return {"next_step": "SCHEDULE_CALENDAR", "delegated_service": "SchedulingAgent"}
