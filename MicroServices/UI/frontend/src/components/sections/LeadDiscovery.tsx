...
export function LeadDiscovery() {
  ...
  const countFound = useCollectorCounter(
    CLIENT_METRICS.prospectsFound,
    1400,
    phase === "done" || phase === "collecting",
  );
  const countMatched = useCollectorCounter(
    CLIENT_METRICS.matchedCriteria,
    1400,
    phase === "done" || phase === "collecting",
  );
  const countHigh = useCollectorCounter(
    CLIENT_METRICS.highOpportunities,
    1400,
    phase === "done" || phase === "collecting",
  );
  ...
  const steps = [
    {
      label: "Connecting to Google Maps & Business Registries…",
      active: phase === "searching",
      done: phase === "collecting" || phase === "done",
    },
    {
      label: "Filtering missing website & high rating signals…",
      active: phase === "collecting",
      done: phase === "done",
    },
    {
      label: "Synthesizing structured business profiles…",
      active: false,
      done: phase === "done",
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-base text-text-secondary max-w-xl mx-auto font-body">
            Target high-intent prospects across maps and business registries
            with custom enterprise filters.
          </p>
        </motion.div>
            ...
            >
              ...
              {phase === "done" && (
                ...
                >
                  ...
                  <div className="glass-card p-4">
                    <div
                      className="text-2xl font-bold font-display text-blue-accent tabular-nums"
                      suppressHydrationWarning
                    >
                  ...
                  <div className="glass-card p-4">
                    <div
                      className="text-2xl font-bold font-display text-emerald-success tabular-nums"
                      suppressHydrationWarning
                    >
