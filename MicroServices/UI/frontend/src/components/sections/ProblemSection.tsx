      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 space-y-16">
        ...
        >
          ...
          <p className="text-base text-text-secondary font-body max-w-2xl mx-auto leading-relaxed">
            ...
            then writes a proposal — for every single lead. Scrape-Verse eliminates that entire chain.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-5xl mx-auto">
          ...
          <motion.div
            ...
            className="glass-card p-8 space-y-5 rounded-3xl border border-sky-500/30"
          >
            <h3 className="text-lg font-bold font-display text-sky-400 flex items-center gap-2">
              <span>Without Scrape-Verse</span>
            </h3>
            <motion.ul
              className="space-y-3"
            ...
            >
              {WITHOUT_ITEMS.map((item, i) => (
                <motion.li
                  ...
                  className="flex items-start gap-3 text-sm font-body text-slate-300 leading-relaxed"
                >
          ...
          <motion.div
            ...
            viewport={{ once: true, margin: '-15%' }}
            transition={{ duration: 0.7, ease: [0.16, 1, 0.3, 1] }}
            className="glass-card p-8 space-y-5 rounded-3xl border border-cyan-500/30"
          >
            <h3 className="text-lg font-bold font-display text-cyan-400 flex items-center gap-2">
              <span>With Scrape-Verse</span>
            </h3>
            <motion.ul
              className="space-y-3"
              variants={containerVariants}
