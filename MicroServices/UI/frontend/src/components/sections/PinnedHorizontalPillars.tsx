...
export function PinnedHorizontalPillars() {
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 w-full mb-10 pt-4">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
          <div>
            <SectionLabel stage="04" label="Modular Architecture" />
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold font-display tracking-tight text-text-primary mt-2">
        ...
        >
          {MARQUEE_ITEMS.map((card, idx) => (
            <motion.div
              ...
              data-cursor-hover
              className="w-[310px] sm:w-[350px] md:w-[370px] min-h-[220px] rounded-2xl p-5 sm:p-6 flex flex-col justify-between relative overflow-hidden shrink-0 glass-liquid border border-white/25 shadow-xl backdrop-blur-2xl transition-all duration-300 group"
              style={{
                boxShadow:
            ...
            >
              ...
              <div className="relative z-10 space-y-2">
                <div className="flex items-center justify-between gap-2">
                  ...
                  <span className="inline-block px-2.5 py-0.5 rounded-full text-[10px] font-mono font-bold uppercase tracking-wider border border-sky-300/35 bg-sky-500/10 text-sky-100 backdrop-blur-md shadow-sm shrink-0">
                    {card.tag}
                  </span>
                </div>
...
function TypewriterDescription({ text }: { text: string }) {
  ...
  return (
    <div ref={containerRef} className="min-h-[48px] flex items-start">
      <p className="text-xs font-body leading-relaxed text-slate-300/95 line-clamp-3">
