          ...
          <div className="lg:col-span-5 space-y-6">
            <div className="glass-level-2 p-6 space-y-4">
              ...
              <div className="space-y-3 font-mono text-xs">
                {[
                  { step: '1. Change Detection', desc: 'Monitors DOM tree variations and selector matches.' },
                  { step: '2. Deconstruction', desc: 'Isolates broken extraction paths from raw payload.' },
