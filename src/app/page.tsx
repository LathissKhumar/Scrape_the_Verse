...
export default function Home() {
  ...
  return (
    <div className="relative min-h-screen bg-[#07090D] text-text-primary selection:bg-violet-accent selection:text-void font-body overflow-x-hidden">
      {/* 1. Fixed Vivid Background Image (Glowing Cabin in Foggy Forest) */}
      <div className="fixed inset-0 z-0 pointer-events-none overflow-hidden">
        ...
        />
        {/* Subtle Top & Bottom Gradient Edge Fade for Header/Footer contrast */}
        <div className="absolute inset-0 bg-gradient-to-b from-[#07090D]/40 via-transparent to-[#07090D]/60 pointer-events-none" />
      </div>

      {/* 2. Floating High-Transparency Glass Container Frame */}
      <motion.div
      ...
      >
        <motion.div
          className="relative min-h-screen bg-[#07090D]/15 backdrop-blur-md border border-white/25 shadow-2xl overflow-hidden transition-all duration-300"
          style={{
            borderRadius: frameRadius,
            boxShadow: '0 30px 100px rgba(0, 0, 0, 0.5), inset 0 1px 1px rgba(255, 255, 255, 0.3)',
          }}
        >
          {/* Top Glass Specular Shine */}
          <div className="absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-white/50 to-transparent pointer-events-none z-50" />
      ...
      >
        <div className="glass-level-3 px-5 py-2.5 rounded-full border border-white/30 shadow-2xl flex items-center gap-3 backdrop-blur-2xl bg-[#07090D]/70">
