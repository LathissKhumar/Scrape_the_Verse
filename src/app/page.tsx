...
export default function Home() {
  ...
  return (
    <div className="relative min-h-screen bg-[#07090D] text-text-primary selection:bg-violet-accent selection:text-void font-body overflow-x-hidden">
      {/* 1. Fixed Cinematic Background Image (Glowing Cabin in Foggy Forest) */}
      <div className="fixed inset-0 z-0 pointer-events-none overflow-hidden">
        <div
          className="absolute inset-0 bg-cover bg-center bg-no-repeat scale-105 filter brightness-90 saturate-[1.1]"
          style={{
            backgroundImage: "url('/images/foggy_cabin_background.jpg')",
          }}
        />
        {/* Soft Vignette Overlay to ensure text readability while maintaining background visibility */}
        <div className="absolute inset-0 bg-gradient-to-b from-[#07090D]/50 via-transparent to-[#07090D]/70" />
      </div>

      {/* 2. Floating Glass Container Frame */}
      <motion.div
      ...
      >
        <motion.div
          className="relative min-h-screen bg-[#07090D]/40 backdrop-blur-xl border border-white/20 shadow-2xl overflow-hidden transition-all duration-300"
          style={{
            borderRadius: frameRadius,
            boxShadow: '0 30px 100px rgba(0, 0, 0, 0.6), inset 0 1px 1px rgba(255, 255, 255, 0.25)',
          }}
        >
          {/* Top Glass Specular Shine */}
          <div className="absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-white/40 to-transparent pointer-events-none z-50" />
      ...
      >
        <div className="glass-level-3 px-5 py-2.5 rounded-full border border-white/25 shadow-2xl flex items-center gap-3 backdrop-blur-2xl bg-[#07090D]/80">
